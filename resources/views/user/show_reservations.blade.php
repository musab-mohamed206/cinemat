 @extends('layouts.layout') @section('content')
     ...
     <div class="row mt-5 mb-5 col-10 ml-auto mr-auto">
         <div class="container">
             <h1 class="mt-0 mb-0">التذكرة</h1>
             <hr>


             <div class="cardWrap">
                 <div class="card cardLeft">
                     <h1>CINEMAT <span>Cinema</span></h1>
                     <div class="title">
                         <h2>{{ $reservation->show->movie->title }}</h2>
                         <span>movie</span>
                     </div>
                     <div class="name">
                     ...
                     <div class="time">
                         <h2>{{ $reservation->show->date->toFormattedDateString() }}</h2>
                         <span>time</span>
                     </div>
